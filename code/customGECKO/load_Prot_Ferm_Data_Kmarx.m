function [pIDs,protData,fermParameters,byProds] = load_Prot_Ferm_Data_Kmarx(grouping)
%load_Prot_Ferm_Data
%
...
fileName = '../../../Databases/abs_proteomics_marxianus.txt';
fID      = fopen(fileName);
...
fileName  = '../../../Databases/fermentationData_marxianus.txt';
fID       = fopen(fileName);
formatStr = '%s';
