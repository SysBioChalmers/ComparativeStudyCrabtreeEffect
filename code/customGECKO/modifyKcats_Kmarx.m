...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function ecModelBatch = modifyKcats_Kmarx(ecModelBatch,expVal,modifiedKcats,name)
...
current = pwd;
load ('../../../ComparativeStudyCrabtreeEffect/data/databases/ProtDatabase_Kmarx.mat')
