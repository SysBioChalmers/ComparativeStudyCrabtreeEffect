function GAM = fitGAM_Kmarx(model,verbose)
% fitGAM
%
...
cd ../../../GECKO2_simulations/code/kma_scripts/
...
if isfield(parameters,'GAM')
    ...
    %Load chemostat data:
    fid = fopen('../../../GECKO2_simulations/code/kma_scripts/chemostatData.tsv','r');
...
model = scaleBioMass_Kmarx(model,Pbase,GAM,false);
cd ../../../GECKO2_simulations/code/kma_scripts/
parameters = getModelParameters;
cd ../../../GECKO/geckomat/limit_proteins
%Relevant positions:
